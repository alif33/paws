...
const Services = () => {
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-[30px] pt-[50px] mx-2 lg:mx-0 lg:pr-4 pb-32">
        <div className="bg-[#FFFFFF] h-[180px] lg:h-[240px] rounded-[20px] border-[1px] border-[#DBD3DC] shadow-sm">
